...
import static com.qubuxing.step.SportStepJsonUtils.getCalorieByStep;
import static com.qubuxing.step.SportStepJsonUtils.getDistanceByStep;
...
//        }
    ...
    private void initNotification(int currentStep) {
        ...
        builder.setContentTitle(getString(R.string.app_name, String.valueOf(currentStep)));
...
//        }
    ...
    private void updateNotification(int stepCount) {
        ...
        builder.setContentTitle(getString(R.string.app_name, String.valueOf(stepCount)));
    ...
    private final IStepGetAidlInterface.Stub mIBinder = new IStepGetAidlInterface.Stub() {
